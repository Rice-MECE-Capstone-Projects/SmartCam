...
This documentation outlines the steps to build the workspace, run the RC car controller, and perform LiDAR-based SLAM.
...
ros2 run teleop_ctrl teleop_ctrl	# Control the robot with the help of keyboard keys as instructed in the same terminal (Recommended to run in the local Ubuntu Server)
...
ros2 launch slam rviz_slam.launch 		# to visualize the slam map in rviz2 (Recommended to run in the local Ubuntu Server)
