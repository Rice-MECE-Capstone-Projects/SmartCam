...
def generate_launch_description():
    ...
    if compiled == 'True':
        rosmentor_description_package_path = get_package_share_directory('simulator')
        ...
        rosmentor_description_package_path = os.path.join(home_dir, 'elec555_group3/src/simulator')
        robot_controller_package_path = os.path.join(home_dir, 'elec555_group3/src/driver/ros_robot_controller')
        controller_package_path = os.path.join(home_dir, 'elec555_group3/src/driver/controller')
